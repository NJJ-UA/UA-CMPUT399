...
switch opts.modelType
  case 'lenet'
    opts.train.learningRate = [0.05*ones(1,15) 0.005*ones(1,10) 0.0005*ones(1,5)] ;%[0.05*ones(1,15) 0.005*ones(1,10) 0.0005*ones(1,5)] ; %[ .05*ones(1,30) 0.01*ones(1,30) 0.005*ones(1,30) 0.001*ones(1,30) 0.0005*ones(1,30)] ;
